...
load_frame = function (i, j) {
    ...
    $('#time' + i).html('<blink>加载中...</blink>').show();
...
$(window).ready(function (){
    ...
    $('#data').click(function () {
        $("#data-form").dialog({
            ...
            modal: true, title: '测试记录',
            open: function (event, ui) {
                $('#data-form textarea').val(display_runs());
            },
            buttons: { '好的': function () {$(this).dialog('close')} },
            close: function () {}
        });
    });
    ...
    $("#help").dialog({
        autoOpen: false, modal: true, title: '帮助',
        buttons: { 'OK': function () {$(this).dialog('close')} }
    });
    ...
    $("#about").dialog({
        width: 400,
        autoOpen: false, modal: true, title: '关于本程序',
        open: function () {
            $('.IE6 #about').supersleight({shim:'img/x.gif'});
        },
        buttons: { '晓得咯！': function () {$(this).dialog('close')} }
    });
    $('#about-link').click(function (){$('#about').dialog('open');});

    $("#share").dialog({
        autoOpen: false, modal: true, title: '将本次测试分享给好友!',
        width: 400,
        open: function () {
    ...
    $("#settings").dialog({
        autoOpen: false, modal: true, title: '设置',
        width: 400,
